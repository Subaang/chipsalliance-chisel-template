...
```sh
git clone git@github.com:Subaang/chipsalliance-chisel-template.git
cd chipsalliance-chisel-template
```
...
#### Commit your changes
```sh
git commit -m 'Starting chipsalliance-chisel-template'
...
```sh
mill chipsalliance-chisel-template.test
```
